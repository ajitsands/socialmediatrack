...
<!-- App modules -->
<script src="js/i18n.js?v=1.1.8"></script>
<script src="js/countries.js?v=1.1.8"></script>
<script src="js/auth.js?v=1.1.8"></script>
<script src="js/api.js?v=1.1.8"></script>

<!-- Admin modules -->
<script src="js/admin/dashboard.js?v=1.1.8"></script>
<script src="js/admin/influencers.js?v=1.1.8"></script>
<script src="js/admin/clients.js?v=1.1.8"></script>
<script src="js/admin/products.js?v=1.1.8"></script>
<script src="js/admin/campaigns.js?v=1.1.8"></script>
<script src="js/admin/analytics.js?v=1.1.8"></script>
<script src="js/admin/points.js?v=1.1.8"></script>
<script src="js/admin/wallet.js?v=1.1.8"></script>
...
<script src="js/client/crm.js?v=1.1.8"></script>
<script src="js/client/wallet.js?v=1.1.8"></script>
